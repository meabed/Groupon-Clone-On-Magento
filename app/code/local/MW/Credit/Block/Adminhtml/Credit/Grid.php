<?php
class MW_Credit_Block_Adminhtml_Credit_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  	...
  	public function __construct()
  	{
      	...
      	$this->setDefaultSort('credit_history_id');
	...
	private function _getEmailArray()
    {
    	$arr = array();
  	...
  	protected function _prepareColumns()
  	{
		...
		$this->addColumn('customer_id', array(
     		'header'    => Mage::helper('credit')->__('Customer'),
    	    'align'     =>'left',
   	       	'index'     => 'customer_id',
			'type'      => 'options',
          	'options'   => $this->_getEmailArray(),
   	   	));
		...
		$this->addExportType('*/*/exportCsv', Mage::helper('credit')->__('CSV'));
		$this->addExportType('*/*/exportXml', Mage::helper('credit')->__('XML'));
