 ...
 */
class Webkul_Customerpartner_Block_Adminhtml_Customer_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
...
*/
	...
	protected function paymentmode()
	{
			...
			$readresult=$write->query("select * from  customerpartner_entity_datapayment  where userid =$id");
			$row = $readresult->fetch();
			if(strlen($row['paymentsource'])>0)		
			{	return '<div class="entry-edit">
							...
							<fieldset>
								<address>
									<strong>'.$row['paymentsource'].'</strong><br>
								</address>
							</fieldset>
						</div>';
			}
